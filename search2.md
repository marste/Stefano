...
<div class="input-group mt-5 px-3">
  <input id="search-input" type="text" class="form-control border border-primary" placeholder="Rechercher billets...">
  <div class="input-group-append">
    <span class="input-group-text border border-primary bg-primary text-white"><i class="fas fa-search"></i></span>
  </div>
  <button class="btn btn-outline-primary ml-1" onclick="location.href = '{{ '/tags' | relative_url }}';">
...
<script>
  var sjs = SimpleJekyllSearch({
        ...
        noResultsText: '<li class="list-group-item">Aucun résultat</li>',
