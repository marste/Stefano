    ...
    <div class="timeline">
      ...
      <div class="card">
        ...
        <span class="company-name">
          <b><a href="http://www.alfavarese.it/" target="_blank" rel="noopener">ALFA S.r.l.</a></b>
        </span>
      ...
      <div class="card">
        <h2 class="role">IT Manager</h2>
        <span class="company-name">
          <b><a href="http://www.siitgroup.com/" target="_blank" rel="noopener">S.I.I.T. S.r.l.</a></b>
        </span>
        ...
        <div class="cv-section">
          ...
          <div class="cv-text">
            <ul>
              ...
              <li>Curare la creazione e l’aggiornamento e la manutenzione di sistemi applicativi diretti a funzioni specifiche nel rispetto delle priorità e linee guida date, in coerenza con il sistema generale</li>
      ...
      <div class="card">
        ...
        <span class="company-name">
          <b><a href="http://www.edisport.it/" target="_blank" rel="noopener">Edisport Editoriale S.p.A.</a></b>
        </span>
        ...
        <div class="cv-section">
          ...
          <div class="cv-text">
            <ul>
              ...
              <li>Pianificazione progettazione e gestione di attività di manutenzione proattiva di reti e servers</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="cv-section">
          ...
          <div class="cv-text">
            ...
            <p>Gestione intranet di gruppo e parte dei siti internet pubblicandone i contenuti in accordo con la divisione marketing e le società esterne.</p>
          </div>
        </div>
      </div>
      ...
      <div class="card">
        <h2 class="role">IT Senior Consultant</h2>
        <span class="company-name">
          <b><a href="http://www.wiit.it/" target="_blank" rel="noopener">WIIT S.p.A.</a></b>
        </span>
      ...
      <div class="card">
        ...
        <span class="company-name">
          <b><a href="https://www.soldionline.it/notizie/azioni-italia/tc-sistema-arriva-il-fallimento" target="_blank" rel="noopener">TC Sistema S.p.A.</a></b>
        </span>
        <span class="company-desc">Azienda ICT per la fornitura di servizi di outsourcing, consulenza, progettazione e gestione di architetture, applicazioni e sicurezza</span>
